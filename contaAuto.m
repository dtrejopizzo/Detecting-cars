...
% or image sequences. This example uses |VideoReader| (MATLAB(R)),
% |implay|, and other Image Processing Toolbox functions to detect
% light-colored cars in a video of traffic. Note that |VideoReader| has
% platform-specific capabilities and may not be able to read the supplied
% Motion JPEG2000 video on some platforms. See <matlab:doc('VideoReader')
...
trafficObj = VideoReader('autos.avi')
